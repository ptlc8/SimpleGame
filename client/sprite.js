const spritesReference = {
	guerrier: {name: 'guerrier', eyesY: 34, shouldersY:43, hipsY:61, handX:37, handY:64, flipHand:true},
	archer: {name: 'archer', eyesY: 34, shouldersY:43, hipsY:61, handX:64, handY:43, flipHand:false},
	assassin: {name: 'assassin', eyesY: 34, shouldersY:44, hipsY:61, handX:64, handY:43, flipHand:false},
	mage: {name: 'mage', eyesY:30, shouldersY:39, hipsY:61, chestScale:1.1, handX:34, handY:62, flipHand:true},
	golem: {name: 'golem', eyesY:29, specialChest:true, shouldersY:31, hipsY:61, specialLegs:true, specialFoot: true, handX:26, handY:67, flipHand:true},
	necromancien: {name: 'necromancien', eyesY:33, shouldersY: 42, hipsY:61, haveOverLegs: true, specialLegs:true, specialFoot: true, handX:72, handY:57},
	alchimiste: {name:'assassin', eyesY: 34, shouldersY:43, hipsY:61, handX:64, handY:43, flipHand:false}
}
async function getSprite(className, hat='', chest='', legs='', foot='', hand='') {
	let promise = new Promise(async(resolve, reject) => {
		...
		let images = [
			...
			{img:await getImage(legs + (ref.specialLegs ? "-"+ref.name : "")), x:16, y:ref.hipsY-16},
